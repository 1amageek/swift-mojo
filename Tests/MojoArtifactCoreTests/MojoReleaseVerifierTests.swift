...
struct MojoReleaseVerifierTests {
  private struct Fixture {
    ...
    init(localDependency: Bool = false) throws {
      ...
      let archiveInput = root.appendingPathComponent(
        "release-archive-input"
      )
      try Data("release archive".utf8).write(to: archiveInput)
      try MojoStaticFrameworkLayout.createFramework(
        at: framework,
        identity: layout.identity,
        archiveURL: archiveInput,
        header: MojoStaticSourceRenderer().header(
          identity: layout.identity
        ),
        moduleMap: MojoStaticSourceRenderer().frameworkModuleMap(
          identity: layout.identity
        ),
        style: .versioned
      )
        ...
        fromPropertyList: [
          "AvailableLibraries": [
            [
              ...
              "BinaryPath": MojoStaticFrameworkLayout.binaryPath(
                identity: layout.identity,
                style: .versioned
              ),
      ...
      let manifest = MojoArtifactManifest(
        ...
        artifactDigest: try MojoCanonicalDigest.tree(
          at: artifact,
          allowedSymbolicLinks:
            try MojoStaticFrameworkLayout
            .allowedSymbolicLinks(
              identity: layout.identity,
              slices: [
                MojoArtifactManifest.Slice(
  ...
  func symbolicLinkManifestIsRejected() throws {
    ...
    #expect(
      throws: MojoArtifactError.symbolicLinkUnsupported(
        manifestURL.path
      )
    ) {
      _ = try fixture.verify()
  ...
  func movingBranchPackageDependencyIsRejected() throws {
    ...
    try packageManifest(
      packageDependencies:
        "[.package(url: \"https://example.com/Dependency.git\", branch: \"main\")]"
    ).write(
      to: fixture.root.appendingPathComponent("Package.swift"),
      atomically: true,
      encoding: .utf8
    ...
    #expect(
      throws: MojoArtifactError.mutablePackageDependencyInRelease(
        "main"
      )
    ) {
      _ = try fixture.verify()
  ...
  func fullRemoteCommitObjectIDIsAccepted() throws {
    ...
    try packageManifest(
      packageDependencies:
        "[.package(name: \"swift-mojo\", url: \"https://example.com/Dependency.git\", revision: \"0123456789abcdef0123456789abcdef01234567\")]"
    ).write(
      to: fixture.root.appendingPathComponent("Package.swift"),
      atomically: true,
      encoding: .utf8
  ...
  func fullSHA256RemoteCommitObjectIDIsAccepted() throws {
    ...
    try packageManifest(
      packageDependencies:
        "[.package(name: \"swift-mojo\", url: \"https://example.com/Dependency.git\", revision: \"0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef\")]"
    ).write(
      to: fixture.root.appendingPathComponent("Package.swift"),
      atomically: true,
      encoding: .utf8
  ...
  func symbolicRevisionIsRejected() throws {
    ...
    try packageManifest(
      packageDependencies:
        "[.package(name: \"swift-mojo\", url: \"https://example.com/Dependency.git\", revision: \"candidate-revision\")]"
    ).write(
      to: fixture.root.appendingPathComponent("Package.swift"),
      atomically: true,
      encoding: .utf8
  ...
  func abbreviatedCommitObjectIDIsRejected() throws {
    ...
    try packageManifest(
      packageDependencies:
        "[.package(name: \"swift-mojo\", url: \"https://example.com/Dependency.git\", revision: \"0123456\")]"
    ).write(
      to: fixture.root.appendingPathComponent("Package.swift"),
      atomically: true,
      encoding: .utf8
  ...
  func exactSemanticVersionIsAccepted() throws {
    ...
    try packageManifest(
      packageDependencies:
        "[.package(url: \"https://example.com/swift-mojo.git\", exact: \"1.2.3\")]"
    ).write(
      to: fixture.root.appendingPathComponent("Package.swift"),
      atomically: true,
      encoding: .utf8
  ...
  func malformedSemanticVersionIsRejected() throws {
    ...
    try packageManifest(
      packageDependencies:
        "[.package(url: \"https://example.com/swift-mojo.git\", exact: \"release-1\")]"
    ).write(
      to: fixture.root.appendingPathComponent("Package.swift"),
      atomically: true,
      encoding: .utf8
  ...
  private func packageManifest(
    packageDependencies: String =
      "[.package(url: \"https://github.com/1amageek/swift-mojo.git\", revision: \"0123456789abcdef0123456789abcdef01234567\")]",
    dependencies: String,
    plugins: String
  ) -> String {
    """
