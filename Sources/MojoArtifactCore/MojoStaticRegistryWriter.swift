...
package struct MojoStaticRegistryWriter: Sendable {
    ...
    package func source(
        ...
        methods.append(contentsOf: MojoOpaqueResourceRendering.registry(inputGraph: inputGraph, identity: identity) {
            Self.sessionDomainID(identity: identity, inputGraph: inputGraph, factoryBindingID: $0)
        })
